...
@if ($loggedUser)
    ...
    <div class="public-auth-row d-flex align-items-center gap-2">
        ...
        @if ($isAdmin)
            <a href="{{ route('admin.users.index') }}" class="btn btn-sm manage-users-btn public-auth-primary">Manage Users</a>
        @endif
...
@else
    <div class="public-auth-row d-flex align-items-center gap-2">
        ...
        <a href="{{ route('user.login', ['next' => $nextPath]) }}" class="btn btn-warning btn-sm public-auth-primary">Login</a>
    </div>
@endif
